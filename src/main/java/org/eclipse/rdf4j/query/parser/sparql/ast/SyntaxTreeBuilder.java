...
// Remove trailing colon from prefix
	...
	final public void ConjGraphPattern() throws ParseException {/* @bgen(jjtree) GraphGraphPattern */
		System.out.println("CONJJJJJJJJJJJJJJJJJJJJ");
		ASTConjGraphPattern jjtn000 = new ASTConjGraphPattern(JJTCONJGRAPHPATTERN);
		boolean jjtc000 = true;
		jjtree.openNodeScope(jjtn000);
		try {
